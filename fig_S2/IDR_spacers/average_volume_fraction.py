import os
import numpy as np
from volume_fraction_analysis import calculate_vf
...
# Save the data
np.savetxt(f'volume_frac_pol_T{T}_IDR.txt', avg_VolumeFracPol)
np.savetxt(f'volume_frac_par_T{T}_IDR.txt', avg_VolumeFracPar)
