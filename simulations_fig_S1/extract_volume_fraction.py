import os
import numpy as np
from volume_fraction_analysis_10beads import calculate_vf

# Directory containing the XYZ files
directory = f"StickerSpacer_Chain10/Out"
...
# Save the data
np.savetxt(f'volume_frac_pol_corwding_sp8.txt', avg_VolumeFracPol)
np.savetxt(f'volume_frac_par_corwding_sp8.txt', avg_VolumeFracPar)
